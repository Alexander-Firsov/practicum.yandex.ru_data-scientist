...
```python
# Названия столбцов созданы в верблюжьем стиле. Предпочтительно перевести в змеиный. # Напишите ваш ответ здесь комментарием. Не удаляйте символ #. Не меняйте тип этой ячейки на Markdown.
```
...
#    track_list = df.groupby(['day','city'])
#    track_list_count = track_list['user_id'].count()
#    return track_list_count[day][city]
